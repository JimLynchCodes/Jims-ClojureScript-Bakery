...
return (new CustomEvent(event_name,(function (){var obj37190 = {"detail":data};
return obj37190;
})()));
} else {
...
var f = (function (){var pred__37197 = cljs.core._EQ_;
var expr__37198 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37197.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37198))){
return ((function (pred__37197,expr__37198){
return (function (p1__37191_SHARP_){
return console.warn(p1__37191_SHARP_);
});
;})(pred__37197,expr__37198))
} else {
if(cljs.core.truth_(pred__37197.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37198))){
return ((function (pred__37197,expr__37198){
return (function (p1__37192_SHARP_){
return console.debug(p1__37192_SHARP_);
});
;})(pred__37197,expr__37198))
} else {
if(cljs.core.truth_(pred__37197.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37198))){
return ((function (pred__37197,expr__37198){
return (function (p1__37193_SHARP_){
return console.error(p1__37193_SHARP_);
});
;})(pred__37197,expr__37198))
} else {
return ((function (pred__37197,expr__37198){
return (function (p1__37194_SHARP_){
return console.log(p1__37194_SHARP_);
});
;})(pred__37197,expr__37198))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37201){
var map__37202 = p__37201;
var map__37202__$1 = ((((!((map__37202 == null)))?((((map__37202.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37202.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__37202):map__37202);
var opts = map__37202__$1;
var eval_fn = cljs.core.get.call(null,map__37202__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37204_SHARP_);
});})(new_def))
);
...
return (function (p__37205){
var vec__37206 = p__37205;
var ky = cljs.core.nth.call(null,vec__37206,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1518440263749
