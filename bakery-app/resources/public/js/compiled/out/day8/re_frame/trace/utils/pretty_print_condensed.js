...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__45683 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45681__$1)].join('')));
...
var G__45690 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__45691 = limit;
var G__45692 = match;
var G__45693 = trunc_prefix;
s = G__45690;
limit = G__45691;
match = G__45692;
trunc_prefix = G__45693;
continue;
}
}
break;
...
var prefix = (function (){var G__45694 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45694),"\u2026/"].join('');
} else {
return G__45694;
}
})();
...
var vec__45696 = day8.re_frame.trace.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__45696,(0),null);
var right = cljs.core.nth.call(null,vec__45696,(1),null);
...
var or__28423__auto__ = (function (){var G__45703 = form.name;
if((G__45703 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__45703,/(^.*\$)(.*)/,"$2");
}
})();
...
//# sourceMappingURL=pretty_print_condensed.js.map?rel=1518440288652
