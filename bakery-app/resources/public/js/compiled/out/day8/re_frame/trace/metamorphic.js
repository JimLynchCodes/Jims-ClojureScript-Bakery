...
return cljs.core.filter.call(null,(function (p1__45804_SHARP_){
return ((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__45804_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__45804_SHARP_) <= ending));
}));
});
...
var and__28411__auto__ = day8.re_frame.trace.metamorphic.fsm_trigger_QMARK_.call(null,event);
...
return cljs.core.map.call(null,day8.re_frame.trace.metamorphic.summarise_event,match);
});
...
var G__45805 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__45805__$1 = (((G__45805 instanceof cljs.core.Keyword))?G__45805.fqn:null);
switch (G__45805__$1) {
...
var and__28411__auto__ = cljs.core.get_in.call(null,sub,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("sub","traits","sub/traits",1778340671),new cljs.core.Keyword(null,"unchanged?","unchanged?",1212001763)], null));
if(cljs.core.truth_(and__28411__auto__)){
return (cljs.core.not_any_QMARK_.call(null,((function (and__28411__auto__){
return (function (p1__45807_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__45807_SHARP_);
});})(and__28411__auto__))
...
var or__28423__auto__ = day8.re_frame.trace.metamorphic.run_queue_QMARK_.call(null,event);
if(cljs.core.truth_(or__28423__auto__)){
return or__28423__auto__;
} else {
return day8.re_frame.trace.metamorphic.event_run_QMARK_.call(null,event);
}
});
/**
...
var and__28411__auto__ = day8.re_frame.trace.metamorphic.event_run_QMARK_.call(null,event);
if(cljs.core.truth_(and__28411__auto__)){
return cljs.core.not.call(null,day8.re_frame.trace.metamorphic.run_queue_QMARK_.call(null,new cljs.core.Keyword(null,"previous-event","previous-event",-726928509).cljs$core$IFn$_invoke$arity$1(state)));
} else {
return and__28411__auto__;
}
}
...
return cljs.core.assoc.call(null,((no_match_QMARK_)?(cljs.core.truth_(day8.re_frame.trace.metamorphic.start_of_epoch_QMARK_.call(null,event))?cljs.core.assoc.call(null,state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):state):(cljs.core.truth_(day8.re_frame.trace.metamorphic.quiescent_QMARK_.call(null,event))?cljs.core.assoc.call(null,cljs.core.update.call(null,state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.call(null,current_match,event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),null):(cljs.core.truth_(day8.re_frame.trace.metamorphic.start_of_epoch_and_prev_end_QMARK_.call(null,event,state))?cljs.core.assoc.call(null,cljs.core.update.call(null,state,new cljs.core.Keyword(null,"partitions","partitions",602979514),cljs.core.conj,cljs.core.conj.call(null,current_match,previous_event)),new cljs.core.Keyword(null,"current-match","current-match",-551498177),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [event], null)):(cljs.core.truth_(day8.re_frame.trace.metamorphic.event_run_QMARK_.call(null,event))?cljs.core.update.call(null,state,new cljs.core.Keyword(null,"current-match","current-match",-551498177),cljs.core.conj,event):state
...
return cljs.core.first.call(null,cljs.core.filter.call(null,day8.re_frame.trace.metamorphic.event_run_QMARK_,match));
});
/**
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__45808_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__45808_SHARP_);
...
}),initial_state,cljs.core.filter.call(null,day8.re_frame.trace.metamorphic.subscription_re_run_QMARK_,filtered_traces));
});
/**
...
})),cljs.core.map.call(null,(function (p__45809){
var vec__45810 = p__45809;
var k = cljs.core.nth.call(null,vec__45810,(0),null);
var v = cljs.core.nth.call(null,vec__45810,(1),null);
...
var new_state = (function (){var G__45813 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
var G__45813__$1 = (((G__45813 instanceof cljs.core.Keyword))?G__45813.fqn:null);
switch (G__45813__$1) {
case "sub/create":
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__45813,G__45813__$1,tags,reaction_id,state){
...
});})(G__45813,G__45813__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__45813__$1)].join('')));
...
return (function (all_state,p__45814){
var vec__45815 = p__45814;
var sub_id = cljs.core.nth.call(null,vec__45815,(0),null);
var sub_state = cljs.core.nth.call(null,vec__45815,(1),null);
...
var pre_epoch_traces = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,day8.re_frame.trace.metamorphic.id_between_xf.call(null,(previous_id + (1)),(first_match_id - (1))),cljs.core.filter.call(null,day8.re_frame.trace.metamorphic.subscription_QMARK_)),filtered_traces);
var epoch_traces = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,day8.re_frame.trace.metamorphic.id_between_xf.call(null,first_match_id,last_match_id),cljs.core.filter.call(null,day8.re_frame.trace.metamorphic.subscription_QMARK_)),filtered_traces);
...
var pre_epoch_state = day8.re_frame.trace.metamorphic.process_sub_traces.call(null,day8.re_frame.trace.metamorphic.reset_sub_state.call(null,reaction_state),pre_epoch_traces);
var epoch_state = day8.re_frame.trace.metamorphic.process_sub_traces.call(null,day8.re_frame.trace.metamorphic.reset_sub_state.call(null,pre_epoch_state),epoch_traces);
...
//# sourceMappingURL=metamorphic.js.map?rel=1518582113913
