...
var len__29592__auto___45732 = arguments.length;
var i__29593__auto___45733 = (0);
while(true){
if((i__29593__auto___45733 < len__29592__auto___45732)){
args__29599__auto__.push((arguments[i__29593__auto___45733]));

var G__45734 = (i__29593__auto___45733 + (1));
i__29593__auto___45733 = G__45734;
continue;
} else {
}
break;
...
day8.re_frame.trace.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__45729){
...
var model = cljs.core.get.call(null,map__45730__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__45730__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__45730__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__45730__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
day8.re_frame.trace.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq45728){
return day8.re_frame.trace.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45728));
});
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__45735_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame.trace.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame.trace.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__29231__auto__ = (function day8$re_frame$trace$view$settings$render_$_iter__45740(s__45741){
return (new cljs.core.LazySeq(null,(function (){
var s__45741__$1 = s__45741;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__45741__$1);
if(temp__4657__auto__){
var s__45741__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__45741__$2)){
var c__29229__auto__ = cljs.core.chunk_first.call(null,s__45741__$2);
var size__29230__auto__ = cljs.core.count.call(null,c__29229__auto__);
var b__45743 = cljs.core.chunk_buffer.call(null,size__29230__auto__);
if((function (){var i__45742 = (0);
while(true){
if((i__45742 < size__29230__auto__)){
var item = cljs.core._nth.call(null,c__29229__auto__,i__45742);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__45743,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__45742,id,item,c__29229__auto__,size__29230__auto__,b__45743,s__45741__$2,temp__4657__auto__){
return (function (){
...
});})(i__45742,id,item,c__29229__auto__,size__29230__auto__,b__45743,s__45741__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__45742,id,item,c__29229__auto__,size__29230__auto__,b__45743,s__45741__$2,temp__4657__auto__){
return (function (p1__45736_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__45736_SHARP_], null));
});})(i__45742,id,item,c__29229__auto__,size__29230__auto__,b__45743,s__45741__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__45748 = (i__45742 + (1));
i__45742 = G__45748;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45743),day8$re_frame$trace$view$settings$render_$_iter__45740.call(null,cljs.core.chunk_rest.call(null,s__45741__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45743),null);
}
} else {
var item = cljs.core.first.call(null,s__45741__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__45741__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__45741__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__45741__$2,temp__4657__auto__){
return (function (p1__45736_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__45736_SHARP_], null));
});})(id,item,s__45741__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame$trace$view$settings$render_$_iter__45740.call(null,cljs.core.rest.call(null,s__45741__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame.trace.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame.trace.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__29231__auto__ = (function day8$re_frame$trace$view$settings$render_$_iter__45744(s__45745){
return (new cljs.core.LazySeq(null,(function (){
var s__45745__$1 = s__45745;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__45745__$1);
if(temp__4657__auto__){
var s__45745__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__45745__$2)){
var c__29229__auto__ = cljs.core.chunk_first.call(null,s__45745__$2);
var size__29230__auto__ = cljs.core.count.call(null,c__29229__auto__);
var b__45747 = cljs.core.chunk_buffer.call(null,size__29230__auto__);
if((function (){var i__45746 = (0);
while(true){
if((i__45746 < size__29230__auto__)){
var item = cljs.core._nth.call(null,c__29229__auto__,i__45746);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__45747,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__45746,id,item,c__29229__auto__,size__29230__auto__,b__45747,s__45745__$2,temp__4657__auto__){
return (function (){
...
});})(i__45746,id,item,c__29229__auto__,size__29230__auto__,b__45747,s__45745__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__45746,id,item,c__29229__auto__,size__29230__auto__,b__45747,s__45745__$2,temp__4657__auto__){
return (function (p1__45737_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__45737_SHARP_], null));
});})(i__45746,id,item,c__29229__auto__,size__29230__auto__,b__45747,s__45745__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__45749 = (i__45746 + (1));
i__45746 = G__45749;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45747),day8$re_frame$trace$view$settings$render_$_iter__45744.call(null,cljs.core.chunk_rest.call(null,s__45745__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__45747),null);
}
} else {
var item = cljs.core.first.call(null,s__45745__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame.trace.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__45745__$2,temp__4657__auto__){
return (function (){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__45745__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__45745__$2,temp__4657__auto__){
return (function (p1__45737_SHARP_){
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__45737_SHARP_], null));
});})(id,item,s__45745__$2,temp__4657__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame$trace$view$settings$render_$_iter__45744.call(null,cljs.core.rest.call(null,s__45745__$2)));
}
} else {
return null;
}
...
return mranderson047.re_frame.v0v10v2.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__45738_SHARP_], null));
});})(low_level_trace))
...
//# sourceMappingURL=settings.js.map?rel=1518582113473
