...
var x__29106__auto__ = (((this$ == null))?null:this$);
var m__29107__auto__ = (ajax.protocols._get_all_headers[goog.typeOf(x__29106__auto__)]);
if(!((m__29107__auto__ == null))){
return m__29107__auto__.call(null,this$);
} else {
var m__29107__auto____$1 = (ajax.protocols._get_all_headers["_"]);
if(!((m__29107__auto____$1 == null))){
return m__29107__auto____$1.call(null,this$);
} else {
...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__29065__auto__,k31586,else__29066__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k31586,else__29066__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31585){
var self__ = this;
var G__31585__$1 = this;
return (new cljs.core.RecordIter((0),G__31585__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31587,other31588){
var self__ = this;
var this31587__$1 = this;
return (!((other31588 == null))) && ((this31587__$1.constructor === other31588.constructor)) && (cljs.core._EQ_.call(null,this31587__$1.status,other31588.status)) && (cljs.core._EQ_.call(null,this31587__$1.body,other31588.body)) && (cljs.core._EQ_.call(null,this31587__$1.status_text,other31588.status_text)) && (cljs.core._EQ_.call(null,this31587__$1.headers,other31588.headers)) && (cljs.core._EQ_.call(null,this31587__$1.was_aborted,other31588.was_aborted)) && (cljs.core._EQ_.call(null,this31587__$1.__extmap,other31588.__extmap));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__29070__auto__,k__29071__auto__,G__31585){
var self__ = this;
var this__29070__auto____$1 = this;
var pred__31591 = cljs.core.keyword_identical_QMARK_;
var expr__31592 = k__29071__auto__;
if(cljs.core.truth_(pred__31591.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__31592))){
return (new ajax.protocols.Response(G__31585,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31591.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__31592))){
return (new ajax.protocols.Response(self__.status,G__31585,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31591.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31592))){
return (new ajax.protocols.Response(self__.status,self__.body,G__31585,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31591.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31592))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__31585,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__31591.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31592))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__31585,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__29071__auto__,G__31585),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__29062__auto__,G__31585){
var self__ = this;
var this__29062__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__31585,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__31589){
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__31589),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__31589),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__31589),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__31589),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__31589),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__31589,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828))),null));
});


//# sourceMappingURL=protocols.js.map?rel=1518440252970
