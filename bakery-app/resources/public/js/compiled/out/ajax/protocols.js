...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__29065__auto__,k32146,else__29066__auto__){
var self__ = this;
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32145){
var self__ = this;
var G__32145__$1 = this;
return (new cljs.core.RecordIter((0),G__32145__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32147,other32148){
var self__ = this;
var this32147__$1 = this;
return (!((other32148 == null))) && ((this32147__$1.constructor === other32148.constructor)) && (cljs.core._EQ_.call(null,this32147__$1.status,other32148.status)) && (cljs.core._EQ_.call(null,this32147__$1.body,other32148.body)) && (cljs.core._EQ_.call(null,this32147__$1.status_text,other32148.status_text)) && (cljs.core._EQ_.call(null,this32147__$1.headers,other32148.headers)) && (cljs.core._EQ_.call(null,this32147__$1.was_aborted,other32148.was_aborted)) && (cljs.core._EQ_.call(null,this32147__$1.__extmap,other32148.__extmap));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__29070__auto__,k__29071__auto__,G__32145){
var self__ = this;
var this__29070__auto____$1 = this;
var pred__32151 = cljs.core.keyword_identical_QMARK_;
var expr__32152 = k__29071__auto__;
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__32152))){
return (new ajax.protocols.Response(G__32145,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__32152))){
return (new ajax.protocols.Response(self__.status,G__32145,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__32152))){
return (new ajax.protocols.Response(self__.status,self__.body,G__32145,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__32152))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__32145,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__32151.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__32152))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__32145,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__29071__auto__,G__32145),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__29062__auto__,G__32145){
var self__ = this;
var this__29062__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__32145,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__32149){
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__32149),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__32149),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__32149),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__32149),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__32149),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__32149,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828))),null));
});


//# sourceMappingURL=protocols.js.map?rel=1518582077825
