...
var G__40449 = o;
(G__40449[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__40455 = jsprops;
(G__40455["defaultValue"] = value);

(G__40455["onChange"] = ((function (G__40455,v,value,on_change){
return (function (p1__40454_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__40454_SHARP_);
});})(G__40455,v,value,on_change))
);
...
var vec__40458 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__40458,(0),null);
var id = cljs.core.nth.call(null,vec__40458,(1),null);
var class$ = cljs.core.nth.call(null,vec__40458,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___40462 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___40462 == null)){
} else {
var key_40463 = temp__4661__auto___40462;
(jsprops["key"] = key_40463);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__40464 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__40464["name"] = c);
...
var len__29592__auto___40469 = arguments.length;
var i__29593__auto___40470 = (0);
while(true){
if((i__29593__auto___40470 < len__29592__auto___40469)){
args__29599__auto__.push((arguments[i__29593__auto___40470]));

var G__40471 = (i__29593__auto___40470 + (1));
i__29593__auto___40470 = G__40471;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40467){
var G__40468 = cljs.core.first.call(null,seq40467);
var seq40467__$1 = cljs.core.next.call(null,seq40467);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__40468,seq40467__$1);
});
...
break;
default:
var G__40474 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__40474;
continue;
...
var n__29368__auto___40476 = a.length;
var i_40477 = (0);
while(true){
if((i_40477 < n__29368__auto___40476)){
(a[i_40477] = reagent.impl.template.as_element.call(null,(a[i_40477])));

var G__40478 = (i_40477 + (1));
i_40477 = G__40478;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29368__auto___40479 = a.length;
var i_40480 = (0);
while(true){
if((i_40480 < n__29368__auto___40479)){
var val_40481 = (a[i_40480]);
if((cljs.core.vector_QMARK_.call(null,val_40481)) && ((reagent.impl.template.key_from_vec.call(null,val_40481) == null))){
(o["no-key"] = true);
} else {
}

(a[i_40480] = reagent.impl.template.as_element.call(null,val_40481));

var G__40482 = (i_40480 + (1));
i_40480 = G__40482;
continue;
} else {
}
...
var ctx = ({});
var vec__40483 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__40483,(0),null);
var derefed = cljs.core.nth.call(null,vec__40483,(1),null);
...
var G__40486 = (cljs.core.count.call(null,argv) - first_child);
switch (G__40486) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__40486){
...
//# sourceMappingURL=template.js.map?rel=1518440271678
