...
var o42018 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42018["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42019 = temp__4655__auto____$1;
return (o42019["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41876__auto__ = f;
return (o__41876__auto__["toString"]).call(o__41876__auto__);
} else {
return "";
}
}catch (e42020){var _ = e42020;
return "";
}});
...
try{var o__41876__auto___42022 = t;
(o__41876__auto___42022["cljs$lang$ctorPrWriter"]).call(o__41876__auto___42022,t,writer);
}catch (e42021){var __42023 = e42021;
}
...
var char_code = (function (){var o__41876__auto__ = (new String(char$));
return (o__41876__auto__["charCodeAt"]).call(o__41876__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41876__auto__ = String;
return (o__41876__auto__["fromCharCode"]).call(o__41876__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42024 = num_code;
switch (G__42024) {
case (1):
return (185);
...
var o__41876__auto__ = String;
return (o__41876__auto__["fromCharCode"]).call(o__41876__auto__,superscript_code);
});
/**
...
}catch (e42026){var _e__41883__auto__ = e42026;
return false;
}})())){
...
var vec__42027 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42027,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o42030 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42030["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42031 = temp__4655__auto____$1;
return (o42031["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29592__auto___42038 = arguments.length;
var i__29593__auto___42039 = (0);
while(true){
if((i__29593__auto___42039 < len__29592__auto___42038)){
args__29599__auto__.push((arguments[i__29593__auto___42039]));

var G__42040 = (i__29593__auto___42039 + (1));
i__29593__auto___42039 = G__42040;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42034){
var vec__42035 = p__42034;
var ns_detector = cljs.core.nth.call(null,vec__42035,(0),null);
...
var G__42041 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42042 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42041;
remaining_tokens = G__42042;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42032){
var G__42033 = cljs.core.first.call(null,seq42032);
var seq42032__$1 = cljs.core.next.call(null,seq42032);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42033,seq42032__$1);
});
...
var vec__42046 = cljs.core.split_with.call(null,(function (p1__42045_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42045_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42046,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42046,(1),null);
...
var vec__42049 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42049,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42049,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42052 = cljs.core.rest.call(null,remaining_tokens);
var G__42053 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42052;
name_tokens = G__42053;
continue;
} else {
...
var vec__42056 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42056,(0),null);
var arity = cljs.core.nth.call(null,vec__42056,(1),null);
var vec__42059 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42059,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42059,(1),null);
var vec__42062 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42062,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42062,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42062,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42062,(3),null);
...
var vec__42068 = result;
var munged_ns = cljs.core.nth.call(null,vec__42068,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42068,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42068,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42068,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42068,(4),null);
var arity = cljs.core.nth.call(null,vec__42068,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__42072 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__42072,(0),null);
var args = cljs.core.nth.call(null,vec__42072,(1),null);
var vec__42075 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42075,(0),null);
var name = cljs.core.nth.call(null,vec__42075,(1),null);
...
var G__42078 = (arity + (1));
var G__42079 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42080){
var vec__42081 = p__42080;
var arity = cljs.core.nth.call(null,vec__42081,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42081,(1),null);
...
return cljs.core.get.call(null,arities,p1__42084_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__42085_SHARP_);
...
var args__29599__auto__ = [];
var len__29592__auto___42092 = arguments.length;
var i__29593__auto___42093 = (0);
while(true){
if((i__29593__auto___42093 < len__29592__auto___42092)){
args__29599__auto__.push((arguments[i__29593__auto___42093]));

var G__42094 = (i__29593__auto___42093 + (1));
i__29593__auto___42093 = G__42094;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42088){
var vec__42089 = p__42088;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42089,(0),null);
...
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__42087,seq42086__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__42097__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42097__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42097__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42097__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42098 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42098,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42098,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42098,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42098,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42098,(4),null);
var arity = cljs.core.nth.call(null,vec__42098,(5),null);
...
var o__41876__auto__ = f;
return (o__41876__auto__["getBasis"]).call(o__41876__auto__);
});
/**
...
}catch (e42102){var _e__41883__auto__ = e42102;
...
var G__42103 = (obj[cljs.core.first.call(null,path)]);
var G__42104 = cljs.core.rest.call(null,path);
obj = G__42103;
path = G__42104;
continue;
} else {
...
return (function (accum,p__42105){
var vec__42106 = p__42105;
var bit = cljs.core.nth.call(null,vec__42106,(0),null);
var protocol = cljs.core.nth.call(null,vec__42106,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42109){
var vec__42110 = p__42109;
var ns = cljs.core.nth.call(null,vec__42110,(0),null);
var name = cljs.core.nth.call(null,vec__42110,(1),null);
var selector = cljs.core.nth.call(null,vec__42110,(2),null);
...
return (function (p__42114){
var vec__42115 = p__42114;
var munged_name = cljs.core.nth.call(null,vec__42115,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42115,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42115,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42113_SHARP_){
return (obj[cljs.core.first.call(null,p1__42113_SHARP_)]);
});})(name,sorted_matches,vec__42115,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1518582102476
