...
var map__51220 = top_item;
var map__51220__$1 = ((((!((map__51220 == null)))?((((map__51220.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51220.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51220):map__51220);
var file = cljs.core.get.call(null,map__51220__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__51220__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__51220__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e51219){var _e = e51219;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___51222 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___51222)){
var seen_errors_51223 = temp__4655__auto___51222;
if(cljs.core.truth_(seen_errors_51223.has(self))){
} else {
seen_errors_51223.add(self);

var temp__4657__auto___51224 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___51224)){
var sense_51225 = temp__4657__auto___51224;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_51225)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1518440307660
