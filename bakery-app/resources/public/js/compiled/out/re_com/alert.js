...
var len__29592__auto___49840 = arguments.length;
var i__29593__auto___49841 = (0);
while(true){
if((i__29593__auto___49841 < len__29592__auto___49840)){
args__29599__auto__.push((arguments[i__29593__auto___49841]));

var G__49842 = (i__29593__auto___49841 + (1));
i__29593__auto___49841 = G__49842;
continue;
} else {
}
break;
...
return re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic(argseq__29600__auto__);
});

re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__49837){
...
var args = map__49838__$1;
var closeable_QMARK_ = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
var body = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var attr = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var heading = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var on_close = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var alert_type = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),new cljs.core.Keyword(null,"info","info",-317069002));
var style = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var id = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var padding = cljs.core.get.call(null,map__49838__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
...
var close_button = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.buttons.button,new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"i","i",-1386841315),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"zmdi created zmdi-hc-fw-rc zmdi-close",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"20px"], null)], null)], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__49838,map__49838__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding){
return (function (event){
on_close.call(null,id);

return null;
});})(map__49838,map__49838__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding))
...
re_com.alert.alert_box.cljs$lang$applyTo = (function (seq49836){
return re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49836));
});
...
var args__29599__auto__ = [];
var len__29592__auto___49855 = arguments.length;
var i__29593__auto___49856 = (0);
while(true){
if((i__29593__auto___49856 < len__29592__auto___49855)){
args__29599__auto__.push((arguments[i__29593__auto___49856]));

var G__49857 = (i__29593__auto___49856 + (1));
i__29593__auto___49856 = G__49857;
continue;
} else {
}
break;
...
var argseq__29600__auto__ = ((((0) < args__29599__auto__.length))?(new cljs.core.IndexedSeq(args__29599__auto__.slice((0)),(0),null)):null);
return re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic(argseq__29600__auto__);
});

re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__49844){
...
var alerts = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"alerts","alerts",-2121664427));
var on_close = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var max_height = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var padding = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"padding","padding",1660304693),"4px");
var border_style = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"border-style","border-style",-485574304));
var class$ = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var attr = cljs.core.get.call(null,map__49845__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,new cljs.core.Keyword(null,"padding","padding",1660304693),padding,new cljs.core.Keyword(null,"border","border",1444987323),border_style,new cljs.core.Keyword(null,"class","class",-2030961996),class$,new cljs.core.Keyword(null,"style","style",-496642736),style,new cljs.core.Keyword(null,"attr","attr",-604132353),attr,new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.scroller,new cljs.core.Keyword(null,"v-scroll","v-scroll",-1842185668),new cljs.core.Keyword(null,"auto","auto",-566279492),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),max_height], null),new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,new cljs.core.Keyword(null,"size","size",1098693007),"auto",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__29231__auto__ = ((function (alerts__$1,map__49845,map__49845__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr){
return (function re_com$alert$iter__49847(s__49848){
return (new cljs.core.LazySeq(null,((function (alerts__$1,map__49845,map__49845__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr){
return (function (){
var s__49848__$1 = s__49848;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__49848__$1);
if(temp__4657__auto__){
var s__49848__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__49848__$2)){
var c__29229__auto__ = cljs.core.chunk_first.call(null,s__49848__$2);
var size__29230__auto__ = cljs.core.count.call(null,c__29229__auto__);
var b__49850 = cljs.core.chunk_buffer.call(null,size__29230__auto__);
if((function (){var i__49849 = (0);
while(true){
if((i__49849 < size__29230__auto__)){
var alert = cljs.core._nth.call(null,c__29229__auto__,i__49849);
cljs.core.chunk_append.call(null,b__49850,(function (){var map__49851 = alert;
...
var id = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.call(null,map__49851__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49850),re_com$alert$iter__49847.call(null,cljs.core.chunk_rest.call(null,s__49848__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__49850),null);
}
} else {
var alert = cljs.core.first.call(null,s__49848__$2);
return cljs.core.cons.call(null,(function (){var map__49853 = alert;
...
var id = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var alert_type = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"alert-type","alert-type",405751817));
var heading = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var body = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var padding__$1 = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"padding","padding",1660304693));
var closeable_QMARK_ = cljs.core.get.call(null,map__49853__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"alert-type","alert-type",405751817),alert_type,new cljs.core.Keyword(null,"heading","heading",-1312171873),heading,new cljs.core.Keyword(null,"body","body",-2049205669),body,new cljs.core.Keyword(null,"padding","padding",1660304693),padding__$1,new cljs.core.Keyword(null,"closeable?","closeable?",1490064409),closeable_QMARK_,new cljs.core.Keyword(null,"on-close","on-close",-761178394),on_close], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),re_com$alert$iter__49847.call(null,cljs.core.rest.call(null,s__49848__$2)));
}
} else {
return null;
}
...
});})(alerts__$1,map__49845,map__49845__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
,null,null));
});})(alerts__$1,map__49845,map__49845__$1,args,alerts,on_close,max_height,padding,border_style,class$,style,attr))
;
return iter__29231__auto__.call(null,alerts__$1);
})()], null)], null)], null)], null)], null);
});

re_com.alert.alert_list.cljs$lang$maxFixedArity = (0);

re_com.alert.alert_list.cljs$lang$applyTo = (function (seq49843){
return re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq49843));
});


//# sourceMappingURL=alert.js.map?rel=1518582128018
