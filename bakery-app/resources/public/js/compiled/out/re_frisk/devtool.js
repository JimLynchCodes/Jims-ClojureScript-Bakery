...
re_frisk.devtool.ie_QMARK_ = (function (){var or__28423__auto__ = cljs.core.re_find.call(null,/MSIE /,re_frisk.devtool.ua);
if(cljs.core.truth_(or__28423__auto__)){
return or__28423__auto__;
} else {
var or__28423__auto____$1 = cljs.core.re_find.call(null,/Trident\//,re_frisk.devtool.ua);
...
var expand_by_default = cljs.core.reduce.call(null,(function (p1__50954_SHARP_,p2__50955_SHARP_){
return cljs.core.assoc_in.call(null,p1__50954_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__50955_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
...
var map__50956 = new cljs.core.Keyword(null,"prefs","prefs",-1818938470).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.deb_data));
...
var ext_height = cljs.core.get.call(null,map__50956__$1,new cljs.core.Keyword(null,"ext_height","ext_height",-46169089));
var ext_width = cljs.core.get.call(null,map__50956__$1,new cljs.core.Keyword(null,"ext_width","ext_width",925500566));
...
(w["onload"] = ((function (map__50956,map__50956__$1,ext_height,ext_width,w,d){
return (function (){
return re_frisk.devtool.mount.call(null,w,d);
});})(map__50956,map__50956__$1,ext_height,ext_width,w,d))
);
...
var len__29592__auto___50961 = arguments.length;
var i__29593__auto___50962 = (0);
while(true){
if((i__29593__auto___50962 < len__29592__auto___50961)){
args__29599__auto__.push((arguments[i__29593__auto___50962]));

var G__50963 = (i__29593__auto___50962 + (1));
i__29593__auto___50962 = G__50963;
continue;
} else {
}
break;
...
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(argseq__29600__auto__);
});

re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic = (function (data){
var expand_by_default = cljs.core.reduce.call(null,(function (p1__50958_SHARP_,p2__50959_SHARP_){
return cljs.core.assoc_in.call(null,p1__50958_SHARP_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"data-frisk","data-frisk",-357579764),p2__50959_SHARP_,new cljs.core.Keyword(null,"expanded-paths","expanded-paths",787811540)], null),cljs.core.PersistentHashSet.createAsIfByAssoc([cljs.core.PersistentVector.EMPTY]));
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.range.call(null,cljs.core.count.call(null,data)));
var state_atom = reagent.core.atom.call(null,expand_by_default);
return ((function (expand_by_default,state_atom){
return (function() { 
var G__50964__delegate = function (data__$1){
...
var G__50964 = function (var_args){
var data__$1 = null;
if (arguments.length > 0) {
var G__50965__i = 0, G__50965__a = new Array(arguments.length -  0);
while (G__50965__i < G__50965__a.length) {G__50965__a[G__50965__i] = arguments[G__50965__i + 0]; ++G__50965__i;}
  data__$1 = new cljs.core.IndexedSeq(G__50965__a,0,null);
} 
return G__50964__delegate.call(this,data__$1);};
G__50964.cljs$lang$maxFixedArity = 0;
G__50964.cljs$lang$applyTo = (function (arglist__50966){
var data__$1 = cljs.core.seq(arglist__50966);
return G__50964__delegate(data__$1);
});
G__50964.cljs$core$IFn$_invoke$arity$variadic = G__50964__delegate;
return G__50964;
})()
;
;})(expand_by_default,state_atom))
...
re_frisk.devtool.re_frisk_panel.cljs$lang$applyTo = (function (seq50960){
return re_frisk.devtool.re_frisk_panel.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq50960));
});

re_frisk.devtool.re_frisk_shell = (function re_frisk$devtool$re_frisk_shell(p__50967){
var map__50968 = p__50967;
var map__50968__$1 = ((((!((map__50968 == null)))?((((map__50968.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50968.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50968):map__50968);
var x = cljs.core.get.call(null,map__50968__$1,new cljs.core.Keyword(null,"x","x",2099068185));
var y = cljs.core.get.call(null,map__50968__$1,new cljs.core.Keyword(null,"y","y",-1757859776));
var width = cljs.core.get.call(null,map__50968__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__50968__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var height__$1 = (cljs.core.truth_((function (){var and__28411__auto__ = re_frisk.devtool.ie_QMARK_;
if(cljs.core.truth_(and__28411__auto__)){
...
return ((function (style,height__$1,style__$1,style__$2,map__50968,map__50968__$1,x,y,width,height){
return (function (_){
...
});})(style,height__$1,style__$1,style__$2,map__50968,map__50968__$1,x,y,width,height))
...
//# sourceMappingURL=devtool.js.map?rel=1518582135812
