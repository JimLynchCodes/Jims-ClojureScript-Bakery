 ...
 */
mranderson047.garden.v1v3v3.garden.compression.token_fn = (function mranderson047$garden$v1v3v3$garden$compression$token_fn(p__43729){
var vec__43730 = p__43729;
var tag = cljs.core.nth.call(null,vec__43730,(0),null);
var re = cljs.core.nth.call(null,vec__43730,(1),null);
return ((function (vec__43730,tag,re){
return (function (s){
...
var len__29592__auto___43735 = arguments.length;
var i__29593__auto___43736 = (0);
while(true){
if((i__29593__auto___43736 < len__29592__auto___43735)){
args__29599__auto__.push((arguments[i__29593__auto___43736]));

var G__43737 = (i__29593__auto___43736 + (1));
i__29593__auto___43736 = G__43737;
continue;
} else {
}
break;
...
return p1__43733_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
mranderson047.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq43734){
return mranderson047.garden.v1v3v3.garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43734));
});
...
var map__43738 = temp__4655__auto__;
...
var tag = cljs.core.get.call(null,map__43738__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__43738__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__43738__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__43741 = cljs.core.subs.call(null,s1,size);
var G__43742 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__43740 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1518440283202
