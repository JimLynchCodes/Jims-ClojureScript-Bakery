...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__41119 = cljs.core.instance_QMARK_;
var expr__41120 = reactive_val;
if(cljs.core.truth_(pred__41119.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__41120))){
return "ra";
} else {
if(cljs.core.truth_(pred__41119.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__41120))){
return "rc";
} else {
if(cljs.core.truth_(pred__41119.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__41120))){
return "rx";
} else {
if(cljs.core.truth_(pred__41119.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__41120))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1518582099979
