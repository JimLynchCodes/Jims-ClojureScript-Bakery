...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__10672 = cljs.core.instance_QMARK_;
var expr__10673 = reactive_val;
if(cljs.core.truth_(pred__10672.call(null,reagent.ratom.RAtom,expr__10673))){
return "ra";
} else {
if(cljs.core.truth_(pred__10672.call(null,reagent.ratom.RCursor,expr__10673))){
return "rc";
} else {
if(cljs.core.truth_(pred__10672.call(null,reagent.ratom.Reaction,expr__10673))){
return "rx";
} else {
if(cljs.core.truth_(pred__10672.call(null,reagent.ratom.Track,expr__10673))){
return "tr";
} else {
return "other";
}
