...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8212__auto__,writer__8213__auto__,opt__8214__auto__){
return cljs.core._write.call(null,writer__8213__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__10524 = o;
(G__10524[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__7575__auto__ = !((jsprops == null));
if(and__7575__auto__){
var and__7575__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__10530 = jsprops;
(G__10530["defaultValue"] = value);

(G__10530["onChange"] = ((function (G__10530,v,value,on_change){
return (function (p1__10529_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10529_SHARP_);
});})(G__10530,v,value,on_change))
);
...
var vec__10533 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10533,(0),null);
var id = cljs.core.nth.call(null,vec__10533,(1),null);
var class$ = cljs.core.nth.call(null,vec__10533,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___10537 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___10537 == null)){
} else {
var key_10538 = temp__4661__auto___10537;
...
var G__10539 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__10539["name"] = c);
...
var len__8756__auto___10544 = arguments.length;
var i__8757__auto___10545 = (0);
while(true){
if((i__8757__auto___10545 < len__8756__auto___10544)){
args__8763__auto__.push((arguments[i__8757__auto___10545]));

var G__10546 = (i__8757__auto___10545 + (1));
i__8757__auto___10545 = G__10546;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8764__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10542){
var G__10543 = cljs.core.first.call(null,seq10542);
var seq10542__$1 = cljs.core.next.call(null,seq10542);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__10543,seq10542__$1);
});
...
break;
default:
var G__10549 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10549;
continue;
...
var n__8532__auto___10551 = a.length;
var i_10552 = (0);
while(true){
if((i_10552 < n__8532__auto___10551)){
(a[i_10552] = reagent.impl.template.as_element.call(null,(a[i_10552])));
...
var a = cljs.core.into_array.call(null,s);
var n__8532__auto___10554 = a.length;
var i_10555 = (0);
while(true){
if((i_10555 < n__8532__auto___10554)){
var val_10556 = (a[i_10555]);
if((cljs.core.vector_QMARK_.call(null,val_10556)) && ((reagent.impl.template.key_from_vec.call(null,val_10556) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10555] = reagent.impl.template.as_element.call(null,val_10556));
...
var ctx = ({});
var vec__10558 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10558,(0),null);
var derefed = cljs.core.nth.call(null,vec__10558,(1),null);
...
var G__10561 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10561) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10561){
