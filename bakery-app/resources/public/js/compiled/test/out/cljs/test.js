...
var G__12840 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12840,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12840;
}
});
...
var or__7587__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__8756__auto___12845 = arguments.length;
var i__8757__auto___12846 = (0);
while(true){
if((i__8757__auto___12846 < len__8756__auto___12845)){
args__8763__auto__.push((arguments[i__8757__auto___12846]));

var G__12847 = (i__8757__auto___12846 + (1));
i__8757__auto___12846 = G__12847;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8764__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12842){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__12843,G__12844,seq12842__$2);
});
...
var file = cljs.core.get.call(null,map__12849__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12849__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12849__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12849,map__12849__$1,file,line,column){
return (function (p1__12848_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12848_SHARP_));
});})(map__12849,map__12849__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__8542__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__8542__auto__,prefer_table__8543__auto__,method_cache__8544__auto__,cached_hierarchy__8545__auto__,hierarchy__8546__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__7587__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__7587__auto__)){
return or__7587__auto__;
} else {
...
var temp__4657__auto___12851 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___12851)){
var message_12852 = temp__4657__auto___12851;
cljs.core.println.call(null,message_12852);
} else {
}
...
var temp__4657__auto___12853 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___12853)){
var message_12854 = temp__4657__auto___12853;
cljs.core.println.call(null,message_12854);
} else {
}
...
var output_dir__$1 = (function (){var G__12855 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12855),"/"].join('');
} else {
return G__12855;
}
})();
...
var temp__4655__auto__ = (function (){var and__7575__auto__ = typeof exception.stack === 'string';
if(and__7575__auto__){
var G__12857 = exception.stack;
var G__12857__$1 = (((G__12857 == null))?null:clojure.string.split_lines.call(null,G__12857));
var G__12857__$2 = (((G__12857__$1 == null))?null:cljs.core.get.call(null,G__12857__$1,depth));
if((G__12857__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12857__$2);
}
} else {
...
var vec__12858 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12858,(0),null);
var column = cljs.core.nth.call(null,vec__12858,(1),null);
var vec__12861 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12861,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12861,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12861,(2),null);
...
var m__$1 = (function (){var G__12864 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12868 = (function (){var G__12867 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12867);
} else {
return G__12867;
}
})();
...
return cljs.core.vary_meta.call(null,G__12869,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12873 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12873,(0),null);
var types = vec__12873;
...
return cljs.core.map.call(null,(function (p__12876){
var vec__12877 = p__12876;
var ns = cljs.core.nth.call(null,vec__12877,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12877,(1),null);
return ((function (vec__12877,ns,vars__$1){
return (function (){
...
var G__12880 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__12880__$1 = (((G__12880 instanceof cljs.core.Keyword))?G__12880.fqn:null);
switch (G__12880__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1){
return (function (){
var seq__12881 = cljs.core.seq.call(null,vars__$1);
var chunk__12882 = null;
var count__12883 = (0);
var i__12884 = (0);
while(true){
if((i__12884 < count__12883)){
var v = cljs.core._nth.call(null,chunk__12882,i__12884);
var temp__4657__auto___12886 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___12886)){
var t_12887 = temp__4657__auto___12886;
each_fixture_fn.call(null,((function (seq__12881,chunk__12882,count__12883,i__12884,t_12887,temp__4657__auto___12886,v,each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12887)));
});})(seq__12881,chunk__12882,count__12883,i__12884,t_12887,temp__4657__auto___12886,v,each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1))
);
} else {
}

var G__12888 = seq__12881;
var G__12889 = chunk__12882;
var G__12890 = count__12883;
var G__12891 = (i__12884 + (1));
seq__12881 = G__12888;
chunk__12882 = G__12889;
count__12883 = G__12890;
i__12884 = G__12891;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__12881);
if(temp__4657__auto__){
var seq__12881__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12881__$1)){
var c__8426__auto__ = cljs.core.chunk_first.call(null,seq__12881__$1);
var G__12892 = cljs.core.chunk_rest.call(null,seq__12881__$1);
var G__12893 = c__8426__auto__;
var G__12894 = cljs.core.count.call(null,c__8426__auto__);
var G__12895 = (0);
seq__12881 = G__12892;
chunk__12882 = G__12893;
count__12883 = G__12894;
i__12884 = G__12895;
continue;
} else {
var v = cljs.core.first.call(null,seq__12881__$1);
var temp__4657__auto___12896__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___12896__$1)){
var t_12897 = temp__4657__auto___12896__$1;
each_fixture_fn.call(null,((function (seq__12881,chunk__12882,count__12883,i__12884,t_12897,temp__4657__auto___12896__$1,v,seq__12881__$1,temp__4657__auto__,each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12897)));
});})(seq__12881,chunk__12882,count__12883,i__12884,t_12897,temp__4657__auto___12896__$1,v,seq__12881__$1,temp__4657__auto__,each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1))
);
} else {
}

var G__12898 = cljs.core.next.call(null,seq__12881__$1);
var G__12899 = null;
var G__12900 = (0);
var G__12901 = (0);
seq__12881 = G__12898;
chunk__12882 = G__12899;
count__12883 = G__12900;
i__12884 = G__12901;
continue;
}
} else {
...
});})(each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1))
);
});})(each_fixture_fn,G__12880,G__12880__$1,env,once_fixtures,each_fixtures,vec__12877,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12880__$1)].join('')));

}
})());
});
;})(vec__12877,ns,vars__$1))
