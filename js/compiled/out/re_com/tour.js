...
return (function (p1__50319_SHARP_,p2__50320_SHARP_){
return cljs.core.assoc.call(null,p1__50319_SHARP_,p2__50320_SHARP_,reagent.core.atom.call(null,false));
});})(tour_map))
,tour_map,tour_spec);
});
/**
...
return cljs.core.doall.call(null,(function (){var iter__29231__auto__ = (function re_com$tour$initialise_tour_$_iter__50321(s__50322){
return (new cljs.core.LazySeq(null,(function (){
var s__50322__$1 = s__50322;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__50322__$1);
if(temp__4657__auto__){
var s__50322__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__50322__$2)){
var c__29229__auto__ = cljs.core.chunk_first.call(null,s__50322__$2);
var size__29230__auto__ = cljs.core.count.call(null,c__29229__auto__);
var b__50324 = cljs.core.chunk_buffer.call(null,size__29230__auto__);
if((function (){var i__50323 = (0);
while(true){
if((i__50323 < size__29230__auto__)){
var step = cljs.core._nth.call(null,c__29229__auto__,i__50323);
cljs.core.chunk_append.call(null,b__50324,cljs.core.reset_BANG_.call(null,step.call(null,tour),false));

var G__50325 = (i__50323 + (1));
i__50323 = G__50325;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50324),re_com$tour$initialise_tour_$_iter__50321.call(null,cljs.core.chunk_rest.call(null,s__50322__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__50324),null);
}
} else {
var step = cljs.core.first.call(null,s__50322__$2);
return cljs.core.cons.call(null,cljs.core.reset_BANG_.call(null,step.call(null,tour),false),re_com$tour$initialise_tour_$_iter__50321.call(null,cljs.core.rest.call(null,s__50322__$2)));
}
} else {
return null;
}
...
return iter__29231__auto__.call(null,new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
...
//# sourceMappingURL=tour.js.map?rel=1518582131082
