...
return cljs.core.map.call(null,(function (p1__46858_SHARP_){
return cljs.core.assoc.call(null,cljs.core.val.call(null,p1__46858_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.key.call(null,p1__46858_SHARP_));
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-traces","traces/all-traces",-755374523)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","ending-trace-id","epochs/ending-trace-id",-1920901579)], null),(function (p__46863,_){
var vec__46864 = p__46863;
var traces = cljs.core.nth.call(null,vec__46864,(0),null);
var beginning = cljs.core.nth.call(null,vec__46864,(1),null);
var ending = cljs.core.nth.call(null,vec__46864,(2),null);
...
day8.re_frame.trace.subs.filter_ignored_views = (function day8$re_frame$trace$subs$filter_ignored_views(p__46867,_){
var vec__46868 = p__46867;
var traces = cljs.core.nth.call(null,vec__46868,(0),null);
var filtered_views = cljs.core.nth.call(null,vec__46868,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (munged_ns,vec__46868,traces,filtered_views){
...
});})(munged_ns,vec__46868,traces,filtered_views))
),traces);
});
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","current-match-state","epochs/current-match-state",-1577612281),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","epoch-root","epochs/epoch-root",-2097634597)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__46871,_){
var vec__46872 = p__46871;
var epochs = cljs.core.nth.call(null,vec__46872,(0),null);
var match_ids = cljs.core.nth.call(null,vec__46872,(1),null);
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","older-epochs-available?","epochs/older-epochs-available?",366051335),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__46875){
var vec__46876 = p__46875;
var current = cljs.core.nth.call(null,vec__46876,(0),null);
var ids = cljs.core.nth.call(null,vec__46876,(1),null);
return (((1) < cljs.core.count.call(null,ids))) && (((current == null)) || ((current > cljs.core.nth.call(null,ids,(0)))));
}));
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","newer-epochs-available?","epochs/newer-epochs-available?",-1411103953),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__46879){
var vec__46880 = p__46879;
var current = cljs.core.nth.call(null,vec__46880,(0),null);
var ids = cljs.core.nth.call(null,vec__46880,(1),null);
...
return cljs.core.filter.call(null,(function (p1__46883_SHARP_){
var or__28423__auto__ = day8.re_frame.trace.metamorphic.request_animation_frame_QMARK_.call(null,p1__46883_SHARP_);
if(cljs.core.truth_(or__28423__auto__)){
return or__28423__auto__;
} else {
return day8.re_frame.trace.metamorphic.request_animation_frame_end_QMARK_.call(null,p1__46883_SHARP_);
}
}),traces);
}));
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("timing","animation-frame-time","timing/animation-frame-time",1905393593),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("timing","animation-frame-traces","timing/animation-frame-traces",394987473)], null),(function (frame_traces,p__46884){
var vec__46885 = p__46884;
var _ = cljs.core.nth.call(null,vec__46885,(0),null);
var frame_number = cljs.core.nth.call(null,vec__46885,(1),null);
var frames = cljs.core.partition.call(null,(2),frame_traces);
var vec__46888 = cljs.core.first.call(null,cljs.core.drop.call(null,(frame_number - (1)),frames));
var start = cljs.core.nth.call(null,vec__46888,(0),null);
var end = cljs.core.nth.call(null,vec__46888,(1),null);
...
return !(cljs.core.empty_QMARK_.call(null,p1__46891_SHARP_));
})], null),null);
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("subs","view-subs","subs/view-subs",253084832),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__46894){
return cljs.core.coll_QMARK_.call(null,G__46894);
...
var G__46897 = (exp - (1));
var G__46898 = (total + (day8.re_frame.trace.subs.sub_type_value.call(null,sub_type) * Math.pow((10),exp)));
var G__46899 = cljs.core.rest.call(null,order__$1);
exp = G__46897;
total = G__46898;
order__$1 = G__46899;
continue;
...
var G__46900 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(t);
var G__46900__$1 = (((G__46900 instanceof cljs.core.Keyword))?G__46900.fqn:null);
switch (G__46900__$1) {
case "sub/create":
 ...
 */
day8.re_frame.trace.subs.prepare_pod_info = (function day8$re_frame$trace$subs$prepare_pod_info(p__46902,p__46903){
var vec__46904 = p__46902;
var sub_info = cljs.core.nth.call(null,vec__46904,(0),null);
var sub_state = cljs.core.nth.call(null,vec__46904,(1),null);
var vec__46907 = p__46903;
var subscription = cljs.core.nth.call(null,vec__46907,(0),null);
var remove_fn = ((cljs.core._EQ_.call(null,subscription,new cljs.core.Keyword("subs","inter-epoch-subs","subs/inter-epoch-subs",-83233716)))?((function (vec__46904,sub_info,sub_state,vec__46907,subscription){
return (function (me){
return (new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me)) == null);
});})(vec__46904,sub_info,sub_state,vec__46907,subscription))
:cljs.core.constantly.call(null,false));
var subx = cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),day8.re_frame.trace.subs.sub_sort_val,cljs.core.map.call(null,((function (remove_fn,vec__46904,sub_info,sub_state,vec__46907,subscription){
return (function (me){
...
return sub__$2;
});})(remove_fn,vec__46904,sub_info,sub_state,vec__46907,subscription))
...
mranderson047.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","visible-subs","subs/visible-subs",-1536647862),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","all-subs","subs/all-subs",1599770325)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","ignore-unchanged-l2-subs?","subs/ignore-unchanged-l2-subs?",-1438622704)], null),(function (p__46910){
var vec__46911 = p__46910;
var all_subs = cljs.core.nth.call(null,vec__46911,(0),null);
var ignore_unchanged_l2_QMARK_ = cljs.core.nth.call(null,vec__46911,(1),null);
...
//# sourceMappingURL=subs.js.map?rel=1518582118889
