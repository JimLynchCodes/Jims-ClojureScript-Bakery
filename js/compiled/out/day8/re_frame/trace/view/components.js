...
day8.re_frame.trace.view.components.search_input = (function day8$re_frame$trace$view$components$search_input(p__45624){
...
var title = cljs.core.get.call(null,map__45625__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.call(null,map__45625__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.call(null,map__45625__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.call(null,map__45625__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.call(null,map__45625__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson047.reagent.v0v7v0.reagent.core.atom.call(null,title);
var save = ((function (val,map__45625,map__45625__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
day8.re_frame.trace.view.components.autoscroll_list = (function day8$re_frame$trace$view$components$autoscroll_list(p__45629,child){
...
var class$ = cljs.core.get.call(null,map__45630__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.call(null,map__45630__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson047.reagent.v0v7v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_){
return (function (p__45632,child__$1){
...
var class$__$1 = cljs.core.get.call(null,map__45633__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__45633,map__45633__$1,class$__$1,node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_.call(null,node,dom_node);
});})(map__45633,map__45633__$1,class$__$1,node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__45630,map__45630__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.call(null,(function (acc,p__45636){
var vec__45637 = p__45636;
var property = cljs.core.nth.call(null,vec__45637,(0),null);
var value = cljs.core.nth.call(null,vec__45637,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__45635_SHARP_){
return clojure.string.split.call(null,p1__45635_SHARP_,/:/);
...
var previous_config__45613__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__45614__auto__ = day8.re_frame.trace.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__45614__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__45614__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__45614__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__45613__auto__);
}});

day8.re_frame.trace.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

day8.re_frame.trace.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq45640){
var G__45641 = cljs.core.first.call(null,seq45640);
var seq45640__$1 = cljs.core.next.call(null,seq45640);
return day8.re_frame.trace.view.components.make_devtools_api_call.cljs$core$IFn$_invoke$arity$variadic(G__45641,seq45640__$1);
});
...
day8.re_frame.trace.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq45645){
return day8.re_frame.trace.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45645));
});
...
var args__29599__auto__ = [];
var len__29592__auto___45650 = arguments.length;
var i__29593__auto___45651 = (0);
while(true){
if((i__29593__auto___45651 < len__29592__auto___45650)){
args__29599__auto__.push((arguments[i__29593__auto___45651]));

var G__45652 = (i__29593__auto___45651 + (1));
i__29593__auto___45651 = G__45652;
continue;
} else {
}
break;
...
day8.re_frame.trace.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq45649){
return day8.re_frame.trace.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45649));
});
...
var args__29599__auto__ = [];
var len__29592__auto___45654 = arguments.length;
var i__29593__auto___45655 = (0);
while(true){
if((i__29593__auto___45655 < len__29592__auto___45654)){
args__29599__auto__.push((arguments[i__29593__auto___45655]));

var G__45656 = (i__29593__auto___45655 + (1));
i__29593__auto___45655 = G__45656;
continue;
} else {
}
break;
...
day8.re_frame.trace.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq45653){
return day8.re_frame.trace.view.components.cljs_devtools_has_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq45653));
});
...
var vec__45657 = jsonml;
var seq__45658 = cljs.core.seq.call(null,vec__45657);
var first__45659 = cljs.core.first.call(null,seq__45658);
var seq__45658__$1 = cljs.core.next.call(null,seq__45658);
var tag_name = first__45659;
var first__45659__$1 = cljs.core.first.call(null,seq__45658__$1);
var seq__45658__$2 = cljs.core.next.call(null,seq__45658__$1);
var attributes = first__45659__$1;
var children = seq__45658__$2;
...
var args__29599__auto__ = [];
var len__29592__auto___45667 = arguments.length;
var i__29593__auto___45668 = (0);
while(true){
if((i__29593__auto___45668 < len__29592__auto___45667)){
args__29599__auto__.push((arguments[i__29593__auto___45668]));

var G__45669 = (i__29593__auto___45668 + (1));
i__29593__auto___45668 = G__45669;
continue;
} else {
}
break;
...
day8.re_frame.trace.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__45663){
var vec__45664 = p__45663;
var class$ = cljs.core.nth.call(null,vec__45664,(0),null);
var expanded_QMARK_ = mranderson047.reagent.v0v7v0.reagent.core.atom.call(null,true);
return ((function (expanded_QMARK_,vec__45664,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__45664,class$))
});

day8.re_frame.trace.view.components.simple_render.cljs$lang$maxFixedArity = (2);

day8.re_frame.trace.view.components.simple_render.cljs$lang$applyTo = (function (seq45660){
var G__45661 = cljs.core.first.call(null,seq45660);
var seq45660__$1 = cljs.core.next.call(null,seq45660);
var G__45662 = cljs.core.first.call(null,seq45660__$1);
var seq45660__$2 = cljs.core.next.call(null,seq45660__$1);
return day8.re_frame.trace.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic(G__45661,G__45662,seq45660__$2);
});
...
//# sourceMappingURL=components.js.map?rel=1518440288271
