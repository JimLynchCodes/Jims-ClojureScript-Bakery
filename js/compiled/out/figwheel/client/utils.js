...
return (new CustomEvent(event_name,(function (){var obj37182 = {"detail":data};
return obj37182;
})()));
} else {
...
var f = (function (){var pred__37189 = cljs.core._EQ_;
var expr__37190 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37189.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37190))){
return ((function (pred__37189,expr__37190){
return (function (p1__37183_SHARP_){
return console.warn(p1__37183_SHARP_);
});
;})(pred__37189,expr__37190))
} else {
if(cljs.core.truth_(pred__37189.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37190))){
return ((function (pred__37189,expr__37190){
return (function (p1__37184_SHARP_){
return console.debug(p1__37184_SHARP_);
});
;})(pred__37189,expr__37190))
} else {
if(cljs.core.truth_(pred__37189.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37190))){
return ((function (pred__37189,expr__37190){
return (function (p1__37185_SHARP_){
return console.error(p1__37185_SHARP_);
});
;})(pred__37189,expr__37190))
} else {
return ((function (pred__37189,expr__37190){
return (function (p1__37186_SHARP_){
return console.log(p1__37186_SHARP_);
});
;})(pred__37189,expr__37190))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37193){
...
var eval_fn = cljs.core.get.call(null,map__37194__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37196_SHARP_);
});})(new_def))
);
...
return (function (p__37197){
var vec__37198 = p__37197;
var ky = cljs.core.nth.call(null,vec__37198,(0),null);
...
}catch (e37203){if((e37203 instanceof Error)){
var e = e37203;
return not_found;
} else {
throw e37203;
...
//# sourceMappingURL=utils.js.map?rel=1518582089693
