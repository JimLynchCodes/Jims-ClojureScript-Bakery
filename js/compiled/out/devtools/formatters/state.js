...
var len__29592__auto___42140 = arguments.length;
var i__29593__auto___42141 = (0);
while(true){
if((i__29593__auto___42141 < len__29592__auto___42140)){
args__29599__auto__.push((arguments[i__29593__auto___42141]));

var G__42142 = (i__29593__auto___42141 + (1));
i__29593__auto___42141 = G__42142;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq42138){
var G__42139 = cljs.core.first.call(null,seq42138);
var seq42138__$1 = cljs.core.next.call(null,seq42138);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__42139,seq42138__$1);
});
...
return (p1__42143_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1518582102699
