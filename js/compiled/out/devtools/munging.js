...
var o42026 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42026["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42027 = temp__4655__auto____$1;
return (o42027["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41884__auto__ = f;
return (o__41884__auto__["toString"]).call(o__41884__auto__);
} else {
return "";
}
}catch (e42028){var _ = e42028;
return "";
}});
...
try{var o__41884__auto___42030 = t;
(o__41884__auto___42030["cljs$lang$ctorPrWriter"]).call(o__41884__auto___42030,t,writer);
}catch (e42029){var __42031 = e42029;
}
...
var char_code = (function (){var o__41884__auto__ = (new String(char$));
return (o__41884__auto__["charCodeAt"]).call(o__41884__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41884__auto__ = String;
return (o__41884__auto__["fromCharCode"]).call(o__41884__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42032 = num_code;
switch (G__42032) {
case (1):
return (185);
...
var o__41884__auto__ = String;
return (o__41884__auto__["fromCharCode"]).call(o__41884__auto__,superscript_code);
});
/**
...
}catch (e42034){var _e__41891__auto__ = e42034;
return false;
}})())){
...
var vec__42035 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42035,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o42038 = temp__4655__auto__;
var temp__4655__auto____$1 = (o42038["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o42039 = temp__4655__auto____$1;
return (o42039["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42042){
var vec__42043 = p__42042;
var ns_detector = cljs.core.nth.call(null,vec__42043,(0),null);
...
var G__42049 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42050 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42049;
remaining_tokens = G__42050;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42040){
var G__42041 = cljs.core.first.call(null,seq42040);
var seq42040__$1 = cljs.core.next.call(null,seq42040);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__42041,seq42040__$1);
});
...
var vec__42054 = cljs.core.split_with.call(null,(function (p1__42053_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42053_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42054,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42054,(1),null);
...
var vec__42057 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42057,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42057,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42060 = cljs.core.rest.call(null,remaining_tokens);
var G__42061 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42060;
name_tokens = G__42061;
continue;
} else {
...
var vec__42064 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42064,(0),null);
var arity = cljs.core.nth.call(null,vec__42064,(1),null);
var vec__42067 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42067,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42067,(1),null);
var vec__42070 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42070,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42070,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42070,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42070,(3),null);
...
var vec__42076 = result;
var munged_ns = cljs.core.nth.call(null,vec__42076,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42076,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42076,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42076,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42076,(4),null);
var arity = cljs.core.nth.call(null,vec__42076,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__42080 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__42080,(0),null);
var args = cljs.core.nth.call(null,vec__42080,(1),null);
var vec__42083 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42083,(0),null);
var name = cljs.core.nth.call(null,vec__42083,(1),null);
...
var G__42086 = (arity + (1));
var G__42087 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42088){
var vec__42089 = p__42088;
var arity = cljs.core.nth.call(null,vec__42089,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42089,(1),null);
...
return cljs.core.get.call(null,arities,p1__42092_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__42093_SHARP_);
...
var args__29599__auto__ = [];
var len__29592__auto___42100 = arguments.length;
var i__29593__auto___42101 = (0);
while(true){
if((i__29593__auto___42101 < len__29592__auto___42100)){
args__29599__auto__.push((arguments[i__29593__auto___42101]));

var G__42102 = (i__29593__auto___42101 + (1));
i__29593__auto___42101 = G__42102;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42096){
var vec__42097 = p__42096;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42097,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42094){
var G__42095 = cljs.core.first.call(null,seq42094);
var seq42094__$1 = cljs.core.next.call(null,seq42094);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__42095,seq42094__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__42105__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42105__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42105__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42105__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42106 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42106,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42106,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42106,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42106,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42106,(4),null);
var arity = cljs.core.nth.call(null,vec__42106,(5),null);
...
var o__41884__auto__ = f;
return (o__41884__auto__["getBasis"]).call(o__41884__auto__);
});
/**
...
}catch (e42110){var _e__41891__auto__ = e42110;
...
var G__42111 = (obj[cljs.core.first.call(null,path)]);
var G__42112 = cljs.core.rest.call(null,path);
obj = G__42111;
path = G__42112;
continue;
} else {
...
return (function (accum,p__42113){
var vec__42114 = p__42113;
var bit = cljs.core.nth.call(null,vec__42114,(0),null);
var protocol = cljs.core.nth.call(null,vec__42114,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42117){
var vec__42118 = p__42117;
var ns = cljs.core.nth.call(null,vec__42118,(0),null);
var name = cljs.core.nth.call(null,vec__42118,(1),null);
var selector = cljs.core.nth.call(null,vec__42118,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__42123,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42123,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42123,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42121_SHARP_){
return (obj[cljs.core.first.call(null,p1__42121_SHARP_)]);
});})(name,sorted_matches,vec__42123,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1518440276857
