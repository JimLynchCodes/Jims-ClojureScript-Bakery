...
var G__40971 = o;
(G__40971[mranderson047.reagent.v0v7v0.reagent.impl.template.cached_prop_name.call(null,k)] = mranderson047.reagent.v0v7v0.reagent.impl.template.convert_prop_value.call(null,v));
...
var G__40977 = jsprops;
(G__40977["defaultValue"] = value);

(G__40977["onChange"] = ((function (G__40977,v,value,on_change){
return (function (p1__40976_SHARP_){
return mranderson047.reagent.v0v7v0.reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__40976_SHARP_);
});})(G__40977,v,value,on_change))
);
...
var vec__40980 = cljs.core.next.call(null,cljs.core.re_matches.call(null,mranderson047.reagent.v0v7v0.reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__40980,(0),null);
var id = cljs.core.nth.call(null,vec__40980,(1),null);
var class$ = cljs.core.nth.call(null,vec__40980,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___40984 = mranderson047.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___40984 == null)){
} else {
var key_40985 = temp__4661__auto___40984;
(jsprops["key"] = key_40985);
}
...
var G__40986 = mranderson047.reagent.v0v7v0.reagent.impl.template.__GT_NativeWrapper.call(null);
(G__40986["name"] = c);
...
var len__29592__auto___40991 = arguments.length;
var i__29593__auto___40992 = (0);
while(true){
if((i__29593__auto___40992 < len__29592__auto___40991)){
args__29599__auto__.push((arguments[i__29593__auto___40992]));

var G__40993 = (i__29593__auto___40992 + (1));
i__29593__auto___40992 = G__40993;
continue;
} else {
}
break;
...
mranderson047.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40989){
var G__40990 = cljs.core.first.call(null,seq40989);
var seq40989__$1 = cljs.core.next.call(null,seq40989);
return mranderson047.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__40990,seq40989__$1);
});
...
break;
default:
var G__40996 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__40996;
continue;
...
var n__29368__auto___40998 = a.length;
var i_40999 = (0);
while(true){
if((i_40999 < n__29368__auto___40998)){
(a[i_40999] = mranderson047.reagent.v0v7v0.reagent.impl.template.as_element.call(null,(a[i_40999])));

var G__41000 = (i_40999 + (1));
i_40999 = G__41000;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29368__auto___41001 = a.length;
var i_41002 = (0);
while(true){
if((i_41002 < n__29368__auto___41001)){
var val_41003 = (a[i_41002]);
if((cljs.core.vector_QMARK_.call(null,val_41003)) && ((mranderson047.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,val_41003) == null))){
(o["no-key"] = true);
} else {
}

(a[i_41002] = mranderson047.reagent.v0v7v0.reagent.impl.template.as_element.call(null,val_41003));

var G__41004 = (i_41002 + (1));
i_41002 = G__41004;
continue;
} else {
}
...
var ctx = ({});
var vec__41005 = mranderson047.reagent.v0v7v0.reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return mranderson047.reagent.v0v7v0.reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__41005,(0),null);
var derefed = cljs.core.nth.call(null,vec__41005,(1),null);
...
var G__41008 = (cljs.core.count.call(null,argv) - first_child);
switch (G__41008) {
case (0):
...
break;
default:
return (mranderson047.reagent.v0v7v0.reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__41008){
...
//# sourceMappingURL=template.js.map?rel=1518582099615
